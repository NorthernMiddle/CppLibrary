...
/**
Courtesy: RobotMesh
Source: https://www.robotmesh.com/studio/264774
...
Brain orientation:
    ...
    flat, with top edge of screen pointed towards the back side of the robot.

Commands demonstrated:

    Double buffering graphics (smoother drawing)
    Drawing lines and circles
    Reading input from the brain LCD
    Turning and driving without joysticks

Drawing commands

    This program uses BrainLCD.draw_line and BrainLCD.draw_circle to put various shapes on the screen.

*/

//#region config_globals
vex::brain      Brain;
vex::motor      motor_R(vex::PORT15, vex::gearSetting::ratio18_1, true);
vex::motor      motor_L(vex::PORT16, vex::gearSetting::ratio18_1, false);
