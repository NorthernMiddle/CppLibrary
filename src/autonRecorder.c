/*************************************************************************************\
/* 
/*  Module:       autonRecorder.h
/*  Author:       Doug Moyers, Team 8756
/*  Date:         Jan 2017
/*  Description:  Records driver control actions to motor statements that can 
/*                be used as an autonomous program.
/*  Version:      1.01
/*
/*  @TODO written in C, needs conversion to C++ for VEXcode 
/*
/*************************************************************************************/
