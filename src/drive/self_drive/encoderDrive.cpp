...
Motor Port 01   LeftMotor     V5 Smart Motor    Left side motor     false
Motor Port 10   RightMotor    V5 Smart Motor    Right side motor    true
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++*/

float wheelDiameter = 10.16;                    //4.0in wheel diameter x 2.54cm/in = 10.16cm
float wheelCirc = PI * wheelDiameter;           //in cm
...
int main() {
    ...
    Brain.Screen.print("User Program has Started.");    //Print to the screen that the program has started.
